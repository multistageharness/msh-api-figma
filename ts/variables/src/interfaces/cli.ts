...
program
  ...
  .option('--format <format>', 'Output format (json)', 'json')
  .action(async (fileKey: string, variableId: string, options: any, command: any) => {
...
program
  ...
  .action(async (fileKey: string, inputFile: string, options: any, command: any) => {
...
program
  ...
  .action(async (fileKey: string, aliasVariableId: string, targetVariableId: string, modeId: string, options: any, command: any) => {
