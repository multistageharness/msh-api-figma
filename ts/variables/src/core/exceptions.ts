...
export class EnterpriseAccessError extends BaseError {
  constructor(message: string = 'This API is only available to full members of Enterprise organizations') {
...
export class CollectionError extends BaseError {
  constructor(message: string, collectionId: any = null, operation: any = null) {
 ...
 */
export function createErrorFromResponse(response: any, url: string, responseData: any = null): BaseError {
