...
function getSDK(options: any, command: any): FigmaCommentsSDK {
...
program
  ...
  .action(async (fileKey: string, commentId: string, options: any, command: any) => {
    if (!options.confirm) {
...
program
  ...
  .action(async (fileKey: string, commentId: string, emoji: string, options: any, command: any) => {
...
program
  ...
  .option('--toggle', 'Toggle reaction (remove if already present)')
  .action(async (fileKey: string, commentId: string, type: string, options: any, command: any) => {
...
program
  ...
  .action(async (fileKey: string, query: string, options: any, command: any) => {
