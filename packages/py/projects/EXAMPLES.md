...
sdk = FigmaProjectsSDK(api_token="...", verify=context)
```
...
```python
sdk = FigmaProjectsSDK(api_token="...", verify=False)
```

```bash
figma-projects list-projects TEAM_ID --no-ssl-verify     # alias: --insecure
```
