...
sdk = FigmaFileSDK(api_key="...", verify=context)
```
...
```python
sdk = FigmaFileSDK(api_key="...", verify=False)
```

```bash
figma-files get-file FILE_KEY --no-ssl-verify     # alias: --insecure
```
