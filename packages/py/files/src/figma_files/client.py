...
from .utils import build_query_params, resolve_verify
...
class FigmaFileClient:
    ...
    def __init__(
        ...
        *,
        ...
        # and fires once however often the client is (re)started.
    ...
    def verify(self) -> bool | str | ssl.SSLContext:
        ...
        Read-only: resolution happens once, in ``__init__``. Surfaces that need
        to build their own httpx clients (the CLI's image downloader, say)
        should read this rather than re-resolving and warning twice.
        """
