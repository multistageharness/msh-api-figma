...
sdk = FigmaVariablesSDK(api_token="...", verify=context)
```
...
```python
sdk = FigmaVariablesSDK(api_token="...", verify=False)
```

```bash
figma-variables list-variables FILE_KEY --no-ssl-verify     # alias: --insecure
```
