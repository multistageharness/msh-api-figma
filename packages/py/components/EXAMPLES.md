...
sdk = FigmaComponentsSDK(api_key="...", verify=context)
```
...
```python
sdk = FigmaComponentsSDK(api_key="...", verify=False)
```

```bash
figma-components components --no-ssl-verify     # alias: --insecure
```
