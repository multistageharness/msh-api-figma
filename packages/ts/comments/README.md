...
```bash
npm install @internal/figma-comments
```
...
```javascript
import FigmaCommentsSDK from '@internal/figma-comments';
...
```javascript
import { FigmaCommentsService } from '@internal/figma-comments';
...
```javascript
import { FigmaCommentsClient } from '@internal/figma-comments';
...
```javascript
import { FigmaCommentsSDK, RateLimiter } from '@internal/figma-comments';
...
```javascript
import { FigmaCommentsSDK, RequestCache } from '@internal/figma-comments';
