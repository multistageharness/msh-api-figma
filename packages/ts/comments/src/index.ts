...
// Re-export utility classes from @internal/figma-api-fetch for convenience
// Users can also import these directly from '@internal/figma-api-fetch' if needed
export { RateLimiter, RequestCache } from "@internal/figma-api-fetch";
// Error classes
export {
  ApiError,
  AuthenticationError,
