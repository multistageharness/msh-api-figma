...
```bash
npm install @internal/figma-library-analytics
```
...
```javascript
import { FigmaLibraryAnalyticsSDK } from '@internal/figma-library-analytics';
...
} from '@internal/figma-library-analytics';
