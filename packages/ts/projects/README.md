...
```bash
npm install @internal/figma-projects
```
...
```javascript
import FigmaProjectsSDK from '@internal/figma-projects';
...
```javascript
import { FigmaProjectsSDK, FigmaProjectsClient } from '@internal/figma-projects';
...
```javascript
import { AuthenticationError, RateLimitError } from '@internal/figma-projects';
